...
> M365 Copilot declarative agent solution for guest permissions visibility. Part of the [dev-agents-solutions](../../README.md) repo — see the root README for the overall architecture and how this agent surface fits alongside the Azure control-plane and Copilot Studio surfaces.
